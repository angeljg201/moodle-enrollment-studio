...
const paymentsData: Record<string, any> = {
  "PAY-001": {
    id: "PAY-001", orderId: "ORD-001", amount: 1200, currency: "PEN",
    method: "YAPE", type: "FULL", status: "CONFIRMED", date: "2024-06-28 14:32",
    transactionId: "YPE-8827391042", receipt: "/placeholder.svg",
    client: { name: "Jorge Castillo", email: "j.castillo@email.com", phone: "+51 987 654 321" },
  },
  "PAY-002": {
    id: "PAY-002", orderId: "ORD-002", amount: 450, currency: "PEN",
    method: "TRANSFERENCIA", type: "INSTALLMENTS", status: "PENDING", date: "2024-06-25 09:15",
    transactionId: "TRF-0042819200", receipt: null,
    client: { name: "Ana Mendoza", email: "a.mendoza@email.com", phone: "+51 912 345 678" },
  },
  "PAY-003": {
    id: "PAY-003", orderId: "ORD-003", amount: 2100, currency: "PEN",
    method: "POS", type: "FULL", status: "FAILED", date: "2024-06-22 17:45",
    transactionId: "POS-5539281746", receipt: null,
    client: { name: "Roberto Sánchez", email: "r.sanchez@email.com", phone: "+51 945 678 901" },
  },
  "PAY-004": {
    id: "PAY-004", orderId: "ORD-002", amount: 500, currency: "PEN",
    method: "EFECTIVO", type: "INSTALLMENTS", status: "REFUNDED", date: "2024-06-20 11:00",
    transactionId: "EFE-0000000000", receipt: "/placeholder.svg",
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground mt-1">ID: {payment.id} • Registrado el {payment.date}</p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Button variant="destructive" size="sm">
            <XCircle size={16} className="mr-1" /> {payment.status === "CONFIRMED" ? "Reembolsar" : "Marcar Fallido"}
          </Button>
        </div>
      </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-semibold text-foreground">{methodLabels[payment.method] || payment.method}</p>
                </div>
                <div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-semibold text-foreground">#{payment.orderId}</p>
                </div>
                <Button variant="outline" size="sm" asChild>
                  <Link to={`/ordenes/${payment.orderId}`}>
                    <FileText size={14} className="mr-1" /> Ver Orden #{payment.orderId}
                  </Link>
                </Button>
              </div>
            </CardContent>
